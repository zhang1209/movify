...
public interface IVideoService {
	 ...
	 * @return
	 */
	List<Map<String,Object>> videoSearch(String key,int pageNo,int pageSize);
	 ...
	 * @param vtime 
	 */
	int upVideo(Integer uid, String vname, String vcountry, String vdirector, int cost, String vstudio,
